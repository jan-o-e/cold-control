...
from ExperiementalRunner import PhotonProductionConfiguration, TdcConfiguration
from ExperiementalRunner import AwgConfiguration, Waveform
    ...
    for channel, waveform_data, waveforms, delay, channel_abs_offset in \
        ...
        for ind, waveform in enumerate(waveforms):
            ...
            if len(waveforms)==1:
                ...
                MARKER_WF_INDICES=[0,2]#IMPORTANT THIS SETS the indices of the waveforms on the marked channel that are actually marked for photon dectection (i.e. the VST pulses)
