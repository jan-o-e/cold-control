...
def plot_pd_data(data):
    ...
    try:
        ...
        ax2.plot(data['Time (s)'], data['Channel 2 Voltage (V)'], label='Channel 2', color='red')
        ax2.set_ylabel('Channel 2 Voltage (V)', color='red')
...
experiment_times = ["16-31-20", "16-31-29", "16-31-37", "16-31-45", "16-31-53", "16-32-01", "16-32-09", "16-32-17", "16-32-25", "16-32-34"]


data1 = pd.read_csv(f"C:\\Users\\apc\\Documents\\Python Scripts\\Cold Control Heavy\\data\\2025-05-22\\A_{experiment_times[0]}_channels_1_2_data")
data2 = pd.read_csv(f"C:\\Users\\apc\\Documents\\Python Scripts\\Cold Control Heavy\\data\\2025-05-22\\A_{experiment_times[1]}_channels_1_2_data")
data3 = pd.read_csv(f"C:\\Users\\apc\\Documents\\Python Scripts\\Cold Control Heavy\\data\\2025-05-22\\A_{experiment_times[2]}_channels_1_2_data")
data4 = pd.read_csv(f"C:\\Users\\apc\\Documents\\Python Scripts\\Cold Control Heavy\\data\\2025-05-22\\A_{experiment_times[3]}_channels_1_2_data")
data5 = pd.read_csv(f"C:\\Users\\apc\\Documents\\Python Scripts\\Cold Control Heavy\\data\\2025-05-22\\A_{experiment_times[4]}_channels_1_2_data")
data6 = pd.read_csv(f"C:\\Users\\apc\\Documents\\Python Scripts\\Cold Control Heavy\\data\\2025-05-22\\A_{experiment_times[5]}_channels_1_2_data")
data7 = pd.read_csv(f"C:\\Users\\apc\\Documents\\Python Scripts\\Cold Control Heavy\\data\\2025-05-22\\A_{experiment_times[6]}_channels_1_2_data")
data8 = pd.read_csv(f"C:\\Users\\apc\\Documents\\Python Scripts\\Cold Control Heavy\\data\\2025-05-22\\A_{experiment_times[7]}_channels_1_2_data")
data9 = pd.read_csv(f"C:\\Users\\apc\\Documents\\Python Scripts\\Cold Control Heavy\\data\\2025-05-22\\A_{experiment_times[8]}_channels_1_2_data")
data10 = pd.read_csv(f"C:\\Users\\apc\\Documents\\Python Scripts\\Cold Control Heavy\\data\\2025-05-22\\A_{experiment_times[9]}_channels_1_2_data")
...
for data in all_data:
    ...
    channel2_col = data['Channel 2 Voltage (V)'].to_numpy()
    if tot_data.empty:
        tot_data['Time (s)'] = time_col
        tot_data['Channel 1 Voltage (V)'] = channel1_col
        tot_data['Channel 2 Voltage (V)'] = channel2_col
    else:
        tot_data['Channel 1 Voltage (V)'] = tot_data['Channel 1 Voltage (V)'].to_numpy() + channel1_col
        tot_data['Channel 2 Voltage (V)'] = tot_data['Channel 2 Voltage (V)'].to_numpy() + channel2_col

    #plot_pd_data(data)

tot_data['Channel 1 Voltage (V)'] = tot_data['Channel 1 Voltage (V)'] / len(all_data)
tot_data['Channel 2 Voltage (V)'] = tot_data['Channel 2 Voltage (V)'] / len(all_data)
